...
export const Hero = () => {
    ...
    return (
        <WarpBackground>
            <div className="relative isolate px-4 sm:px-6 sm:pt-14 lg:px-8" >
                <div
                    aria-hidden="true"
                ...
                <div className="max-w-2xl py-32 sm:py-48 lg:py-56" data-aos="fade-up">
                    <div className="">
                        <h1 className="flex flex-col text-3xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
                            <span>Hi, I am</span>
                            <span>Prince Khant</span>
                        </h1>
                        <div className="flex items-center text-[18px] justify-start gap-x-2 mt-4 text-pretty text-gray-700 sm:text-4xl">
                            <span>
                                I am a
                            </span>
                            <WordRotate
                                className="text-[20px] font-bold text-purple-500 dark:text-white sm:text-4xl"
